      ...
      <div className="bg-pakistanGreen py-8 md:py-24">
          ...
          component1={
            <>
              <div className="flex flex-col space-y-8">
                ...
                <div
                  className={`text-white text-lg md:text-xl lg:text-3xl ${aleo.className}`}
                >
                  {`"`}Voyager has completely transformed the way we handle
                  invoicing. What used to take us hours to manually input and
                  process can now be done in a fraction of the time. We are able
                  to get a real-time view of our financials and track our cash
                  flow with ease. It is a game-changer for our business.{`"`}
                </div>
        ...
        <div className="container pt-8 flex flex-col space-y-8">
          ...
          <div className="flex flex-row items-center gap-5">
            <FaArrowLeft
              size={"2.2rem"}
              className="text-pakistanGreen bg-white p-[8px] cursor-pointer rounded-full"
            />
            <FaArrowRight
              size={"2.2rem"}
              className="text-pakistanGreen bg-white p-[8px] cursor-pointer rounded-full"
